...
export default function App() {
  ...
  const renderScene = SceneMap({
    currently: () => <CurrentlyScreen searchText={searchText} geoLocation={geoLocation} />,
    today: () => <TodayScreen searchText={searchText} geoLocation={geoLocation} />,
    weekly: () => <WeeklyScreen searchText={searchText} geoLocation={geoLocation} />,
  });
