...
export default function TodayScreen({errorgeoLocation, fullInputText, latitude, longitude }) {
      ...
      <Text style={[styles.text, isLargeScreen && styles.textweb]}>
        {
          fullInputText ? (
            <View style={[styles.row, isLargeScreen && styles.rowWeb]}>
              <Text style={[styles.cityName, isLargeScreen && styles.cityNameWeb]}>Today</Text>
